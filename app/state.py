...
state = {
    "balance": STARTING_BALANCE, "initial_balance": STARTING_BALANCE,
    "peak_balance": STARTING_BALANCE, "total_pnl": 0.0, "pnl": 0.0,
    "positions": [], "trades": [],
    "total_trades": 0, "winning_trades": 0, "losing_trades": 0,
    "max_drawdown": 0.0, "daily_trades": 0, "daily_wins": 0,
    "daily_loss": 0.0, "daily_reset_hour": -1,
    "prices":      {p: 0.0 for p in PAIRS},
    "candles":     {p: []  for p in PAIRS},   # 5m candles
    "candles_1h":  {p: []  for p in PAIRS},   # 1H candles (HTF bias)
